    ...
    return (
        <React.Fragment>
            ...
            <ul>
                {courses.map(course => {
                    return (
                        <li key={course.id} style={{listStyleType : "None"}} className={"list-container"}>
                            <div className={"list-image"}>
                                <img src={course.url} alt={course.courseName} width={"120px"} height={"120px"}/>
                            </div>
                            ...
                            <div className={"list-ops"}>
                                ...
                                <p>Instructor:<br/> {course.instructor}</p>
